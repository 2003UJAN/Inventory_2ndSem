...
/* This function will return 0 if an item cannot issued, else issued the item */
IssueItem()
{
float issueqnty;
DisplayItemInfo();
...
/* This structure is used color setting for the application */
struct colors
{
char cfg_name[10];
...
/* Sets the default color setting for the application */
SetDefaultColor()
{
